  ...
  if ~nargin,
      if ~DIVA_x.debug
          ...
          varargout{1}=struct(...
              ...
              'Plots_dim',{[{1:10},num2cell(1:10),{11,12,13}]},...
              'Plots_label',{[{'VocalTract'},{'Jaw','Lip opening','Lip protrusion','Soft palate','Larynx height','Tongue 1','Tongue 2','Tongue 3','Tongue 4','Tongue 5'}]} ),... %;arrayfun(@(n)sprintf('vt%d',n),1:10,'uni',0),{'tension','pressure','voicing'}]} ),...
              'Output',[...
              struct(...
              'Name','Auditory',...
              'Dimensions',4,...
