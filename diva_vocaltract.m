  ...
  if ~nargin,
      if ~DIVA_x.debug
          ...
          varargout{1}=struct(...
              ...
              'Plots_label',{[{'VocalTract'},{'Jaw','Lip opening','Lip protrusion','Soft palate','Larynx height','Tongue_1','Tongue_2','Tongue_3','Tongue_4','Tongue_5','Glottis','Testion','Pressure','Voicing'}]} ),... %;arrayfun(@(n)sprintf('vt%d',n),1:10,'uni',0),{'tension','pressure','voicing'}]} ),...
              'Output',[...
              struct(...
              'Name','Auditory',...
              'Dimensions',4,...
